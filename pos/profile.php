...
<!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Mon compte</h1>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="username" value="<?php echo $item['username']; ?>">
                                    <div class="form-group">
                                     <input class="form-control" type="password" placeholder="new password" name="modifpwpos" style="width:50%" minlength="6">
